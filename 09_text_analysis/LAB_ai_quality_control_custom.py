...
OLLAMA_MODEL = "llama3.2:1b"  # Use a locally available model that supports JSON output
...
def create_quality_control_prompt(report_text, source_data=None):
    ...
    instructions = (
        ...
        "Evaluate the following report text on multiple criteria and return only valid JSON. "
...
Return your response as valid JSON in this exact format:
{
  ...
  "succinctness": 1-5,
  "relevance": 1-5,
  "details": "0-30 word explanation of your assessment"
}
"""
